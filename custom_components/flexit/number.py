...
from homeassistant.components.number.const import DEFAULT_MAX_VALUE, DEFAULT_MIN_VALUE, MODE_AUTO
...
async def async_setup_entry(
    ...
    for description in NUMBERS:
        if description.entity == FlexitAwayTempNumber:
...
class FlexitNumberEntityDescription(NumberEntityDescription):
    ...
    entity: FlexitNumber = FlexitNumber
...
class FlexitNumber(CoordinatorEntity, NumberEntity):
    ...
    def __init__(
        ...
        self._attr_min_value = description.min_value | DEFAULT_MIN_VALUE
        self._attr_max_value = description.max_value | DEFAULT_MAX_VALUE
