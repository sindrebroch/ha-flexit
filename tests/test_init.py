...
from custom_components.flexit import (
    async_reload_entry,
    async_setup_entry,
    async_unload_entry,
)
from custom_components.flexit.const import DOMAIN
...
async def test_setup_unload_and_reload_entry(hass, bypass_get_data):
    ...
    assert (
        type(hass.data[DOMAIN][config_entry.entry_id]) == FlexitDataUpdateCoordinator
    )
